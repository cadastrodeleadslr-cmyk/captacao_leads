...
export const IMOBILIARIAS_DATA: Imobiliaria[] = generateDatabase();
...
export const INITIAL_BUYER_LEADS: BuyerLead[] = [
  {
    ...
    telefone: "(21) 98711-2041",
    whatsapp: "5521987112041",
    email: "carolina.santos.ter@outlook.com",
    redeSocial: "@carol_santos_ter",
    cidade: "Teresópolis",
    bairroInteresse: "Agriões",
    tipoImovel: "Apartamento",
    valorMaximo: 550000,
    quartos: 2,
    origem: "Busca Google (Intenção)",
    dataCaptura: "2026-06-24",
    status: "Pendente",
    detalhes: "Busca apartamento com varanda gourmet, preferencialmente andar alto e 1 vaga de garagem."
  },
  {
    id: "lead-2",
    nome: "Eduardo Ribeiro Coutinho",
    telefone: "(21) 97103-3452",
    whatsapp: "5521971033452",
    email: "edu.coutinho.rio@gmail.com",
    redeSocial: "linkedin.com/in/eduardocoutinho",
    cidade: "Teresópolis",
    bairroInteresse: "Alto",
    tipoImovel: "Casa em Condomínio",
    valorMaximo: 1200000,
    quartos: 3,
    origem: "Grupo Facebook (Classificados)",
    dataCaptura: "2026-06-23",
    status: "Pendente",
    detalhes: "Família do Rio de Janeiro querendo subir para a Serra. Exige área de lazer no condomínio e segurança total."
  },
  {
    id: "lead-3",
    nome: "Mariana Alencar Reis",
    telefone: "(24) 99245-8811",
    whatsapp: "5524992458811",
    email: "mari_reis_alencar@gmail.com",
    redeSocial: "@mari_alencar_decor",
    cidade: "Teresópolis",
    bairroInteresse: "Várzea",
    tipoImovel: "Apartamento",
    valorMaximo: 380000,
    quartos: 2,
    ...
    dataCaptura: "2026-06-24",
    status: "Pendente",
    detalhes: "Compradora local, buscando apartamento para morar com seu pet. Precisa ser próximo a comércio e condução."
  },
  {
    id: "lead-4",
    nome: "Carlos Frederico Bittencourt",
    telefone: "(21) 98111-4099",
    whatsapp: "5521981114099",
    email: "cf.bittencourt@globo.com",
    redeSocial: "@cf_bittencourt",
    cidade: "Teresópolis",
    bairroInteresse: "Albuquerque",
    tipoImovel: "Sítio/Chácara",
    valorMaximo: 1500000,
    quartos: 4,
    origem: "Portal OLX Lead",
    dataCaptura: "2026-06-22",
    status: "Pendente",
    detalhes: "Busca chácara com piscina, churrasqueira e nascente ou riacho. Para lazer nos fins de semana."
  },
  {
    id: "lead-5",
    nome: "Juliana Ferreira Lima",
    telefone: "(21) 99122-3022",
    whatsapp: "5521991223022",
    email: "juliana.lima.advocacia@gmail.com",
    redeSocial: "@julianaferreira_adv",
    cidade: "Teresópolis",
    bairroInteresse: "Granja Comary",
    tipoImovel: "Casa em Condomínio",
    valorMaximo: 1800000,
    quartos: 4,
    origem: "Busca Google (Intenção)",
    dataCaptura: "2026-06-24",
    status: "Pendente",
    detalhes: "Prefere alto padrão na Granja Comary, com vista direta para a CBF ou Dedo de Deus."
  },
  {
    id: "lead-6",
    nome: "Gustavo Mendes da Rocha",
    telefone: "(21) 97455-1122",
    whatsapp: "5521974551122",
    email: "gustavomendesrocha@gmail.com",
    redeSocial: "@gustavo_mendes_rocha",
    cidade: "Guapimirim",
    ...
    quartos: 3,
    origem: "Fórum Local",
    dataCaptura: "2026-06-21",
    status: "Contatado",
    detalhes: "Procura casa linear com quintal para criação de cães de médio porte."
  },
  {
    id: "lead-7",
    nome: "Roberto Linhares Albuquerque",
    telefone: "(21) 98234-5566",
    whatsapp: "5521982345566",
    email: "roberto.linhares@hotmail.com",
    redeSocial: "linkedin.com/in/robertolinhares",
    cidade: "Nova Friburgo",
    bairroInteresse: "Cônego",
    tipoImovel: "Casa",
    valorMaximo: 850000,
    quartos: 3,
    origem: "Busca Google (Intenção)",
    dataCaptura: "2026-06-23",
    status: "Pendente",
    detalhes: "Procura casa de alto padrão com lareira e boa insolação na serra de Nova Friburgo."
  }
];
